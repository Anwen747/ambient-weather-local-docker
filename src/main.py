...
# changes to original code by Anwen as noted in comments below
...
# set MQTT vars
MQTT_BROKER_HOST = os.getenv('MQTT_BROKER_HOST', "your_mqtt_broker_ip")
...
client.will_set(MQTT_TOPIC_PREFIX+"/status", payload="Offline",
                qos=1, retain=True)  # set LWT
...
def application(environ, start_response):
    ...
    # change to original code by Anwen: commented out the first line below and changed the second based on a comment
    # here by Murl Easley here: https://austinsnerdythings.com/2021/03/20/handling-data-from-ambient-weather-ws-2902c-to-mqtt/
    #parsed = urlparse(url)
...
if __name__ == '__main__':
    ...
    # Change to original code by Anwen:  my awnet app is set to use port 7080 not port 80
